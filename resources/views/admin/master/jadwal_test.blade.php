...
<div class="row mb-3">
    <div class="col-12">
        <h6 class="card-title">Perbarui Waktu Pendaftaran</h6>
    </div>
</div>
<div class="row">
            ...
            <div class="card-body">
                ...
                @if ($data == null)
                    <div class="alert alert-danger" role="alert">
                        <p>Kartu peserta tidak akan bisa di download jiak, anda belum menentukan Waktu Pendaftaran!</p>
                    </div>
                @endif
        ...
        <div class="card">
            @if ($data == null)
                <div class="card-body text-center" style="background: rgb(255, 63, 63);border-radius:10px">
                    <h4 class="text-white font-weight-bold">Waktu Pendaftaran Belum Di Atur</h4>
                </div>
            @else
                <div class="card-body text-center" style="border:1px solid #e9af00;border-radius:10px">
                    <h4 class="text-orange font-weight-bold">Waktu Pendaftaran</h4>
                    <hr>
                    <div class="row">
                        <div class="col-5">
