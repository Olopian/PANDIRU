...
<html lang="en">
    <head>
        ...
        <title>
            Surat Pernyataan Calon Peserta Didik Baru - {{ $data->nama_lengkap }}
        </title>
    ...
    <body>
        ...
        <div class="row m-0">
            ...
            <div class="col-12">
                ...
                <h6 class="mb-2">Dengan ini kami menyatakan dengan sesungguhnya, bahwa selama di Sekolah ini:</h6>
                <h6 class="ps-2">1. &nbsp;Akan belajar dengan tekun, sungguh-sungguh dan penuh semangat;</h6>
                <h6 class="ps-2">2. &nbsp;Akan menjaga nama baik diri sendiri, keluarga, masyarakat dan Sekolah;</h6>
                <h6 class="ps-2">3. &nbsp;Sanggup mentaati seluruh tata tertib dan peraturan yang berlaku, mematuhi pelaksanaan wiyata mandala termasuk berpakaian seragam Sekolah, OSIS dan lain lain;</h6>
                <h6 class="ps-2">4. &nbsp;Siap menerima sanksi sesuai dengan ketentuan Sekolah;</h6>
                ...
                <h6 class="mb-1">Hapus bagian "*" Yang tidak diperlukan.</h6>
