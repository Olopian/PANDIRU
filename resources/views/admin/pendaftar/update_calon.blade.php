                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control {{ $data->agama == null ? 'null_data' : '' }}" name="agama" style="border-radius: 10px" data-width="100%">
                        ...
                        <div class="col-12 col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label for="asal_sekolah">Nama asal Sekolah/Sederajat</label>
                                ...
                                <div class="col-12 col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label for="npsn_asal_sekolah">NPSN Asal Sekolah/Sederajat</label>
                                        <input type="number" class="form-control {{ $data->npsn_asal_sekolah == null ? 'null_data' : '' }}" id="npsn_asal_sekolah" name="npsn_asal_sekolah"  value="{{ $data->npsn_asal_sekolah }}" placeholder="NPSN Asal Sekolah/Sederajat" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
