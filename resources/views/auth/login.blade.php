                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 pl-md-0">
                                        <div class="auth-form-wrapper px-4 py-4">
                                            ...
                                            <h5 class="text-muted font-weight-normal mb-4">Selamat datang di sistem pengelolaan Peserta Didik Baru SMP-SMA YAPIM BIRU-BIRU</h5>
                                            <form class="forms-sample" id="form_login" method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mt-4 d-flex">
                                                    <button type="submit" id="submit_button"  class="btn btn-blue mr-2 mb-2 mb-md-0 text-white">
                                                        Masuk
                                                    </button>
