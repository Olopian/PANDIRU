<nav class="sidebar">
    <div class="sidebar-header">
        <a href="#" class="sidebar-brand">YAPIM BIRU-BIRU<span> PPDB</span></a>
        ...
        <ul class="nav">
            ...
            <li class="nav-item @yield('tes')">
                <a href="{{ route('input_hasil_tes') }}" class="nav-link">
                    ...
                    <span class="link-title">Input Hasil Pendaftaran</span>
                </a>
            </li>
            ...
            <li class="nav-item ">
                <a class="nav-link" data-toggle="collapse" href="#seleksi" role="button" aria-expanded="false" aria-controls="forms">
                    <i class="link-icon" data-feather="users"></i>
                    <span class="link-title">Hasil Pendaftaran</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                @php
                ...
                <div class="collapse" id="seleksi">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('peserta_lolos') }}" class="nav-link @yield('peserta_lolos')">Terdaftar ({{ $total['lulus'] }})</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('peserta_reject') }}" class="nav-link @yield('peserta_reject')">Tidak Terdaftar ({{ $total['tidak_lulus'] }})</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item ">
                ...
                <div class="collapse" id="laporan">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('peserta_lolos_print') }}" class="nav-link @yield('peserta_lolos_print')">Data Peserta Terdaftar</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item ">
                ...
                <div class="collapse" id="biaya">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('biaya_infaq') }}" class="nav-link @yield('biaya_infaq')">Pendaftaran</a>
                        </li>
                        <li class="nav-item">
