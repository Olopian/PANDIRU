            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <p class="mb-0 fw-bold h4 text-center">YAPIM BIRU-BIRU</p>
                ...
                <table  class="w-100 mb-2 ">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Agama</td>
                            <td style="width: 5px">:</td>
                            <td>{{  $data->agama == 'kristen Protestan' ? 'Khatolik' : 'Kristen Protestan'}}</td>
                        </tr>
                        <tr>
                ...
                <table  class="w-100 mb-2 ">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center" style="width: 50%">Deli Serdang, .......... {{ date('M') }} {{ date('Y') }}</td>
                        </tr>
                        <tr>
