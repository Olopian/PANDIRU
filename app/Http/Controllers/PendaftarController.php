...
class PendaftarController extends Controller
{
    ...
    public function peserta_lolos_print(Request $request)
    {
        $id = $request->input('id');
        $data = DB::table('pendaftar')->where('id', $id)->first();
    ...
    // Validasi input
    $request->validate([
        'agama' => 'required|string|max:2',  // Menyesuaikan dengan panjang value agama (contoh KP, K, I)
    ]);
    ...
    return redirect()->route('view_calon', $id)->with('success', 'Biodata berhasil diperbarui!');
    }
